...
class MvarStatController {
    ...
    @ApiOperation(
            value = "Get MVAR Sources",
            nickname = "mvarStat/sources",
            produces = "application/json",
            consumes = "application/json",
            httpMethod = "GET",
    ...
    def sources() {
        def sources = mvarStatService.getSources()
        render(view: 'index', model: [sourceList: sources, sourceCount: sources.size()])
    }
}
