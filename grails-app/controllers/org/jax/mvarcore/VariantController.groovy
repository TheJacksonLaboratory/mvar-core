...
class VariantController implements GrailsConfigurationAware {
    ...
    @ApiImplicitParams([
            ...
            @ApiImplicitParam(name = "gene", paramType = "query", required = false, value = "Gene symbol", dataType = "string list"),
            @ApiImplicitParam(name = "strain", paramType = "query", required = false, value = "Strain name", dataType = "string list"),
            @ApiImplicitParam(name = "variantRefTxt", paramType = "query", required = false, value = "Variant canonical Id", dataType = "string list"),
            @ApiImplicitParam(name = "mvarId", paramType = "query", required = false, value = "MVAR id: MCA_*", dataType = "string list"),
            @ApiImplicitParam(name = "type", paramType = "query", required = false, value = "Variant type: can be SNP, INS or DEL", dataType = "string list"),
            @ApiImplicitParam(name = "annotation", paramType = "query", required = false, value = "Sequence Ontology name", dataType = "string list"),
            @ApiImplicitParam(name = "hgvs", paramType = "query", required = false, value = "HGVS genomic nomenclature", dataType = "string list"),
            @ApiImplicitParam(name = "dbSNPid", paramType = "query", required = false, value = "dbSNP ID", dataType = "string list"),
            @ApiImplicitParam(name = "impact", paramType = "query", required = false, value = "Variant impact", dataType = "string list"),
